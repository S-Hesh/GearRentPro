...
public class CustomerEntity {
    ...
    public CustomerEntity(String customerId, String fullName, String nicPassport, String contactNo, String email, String address, String membershipLevelCode) {
    ...
    public String toString() {
        return "CustomerEntity{" + "customerId=" + customerId + ", fullName=" + fullName + ", nicPassport=" + nicPassport + ", contactNo=" + contactNo + ", email=" + email + ", address=" + address + ", membershipLevelCode=" + membershipLevelCode + '}';
    }
