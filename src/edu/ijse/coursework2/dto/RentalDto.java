...
public class RentalDto {
    ...
    public RentalDto(String rentalId, String reservationId, String equipmentId, String customerId, String branchId, Date startDate, Date endDate, double calculatedRentalAmount, double membershipDiscount, double longRentalDiscount, double finalPayableAmount, double securityDeposit, double amountPaid, String paymentStatus, String rentalStatus, String issuedBy, Date actualReturnDate, int lateDays, double lateFeeAmount, String damageDescription, double damageCharge, double totalCharges, double refundAmount) {
